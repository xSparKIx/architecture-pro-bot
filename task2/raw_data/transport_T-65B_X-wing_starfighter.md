...
Model
T-65B space superiority fighter
Type
Starfighter
Snub-fighter
Cost
150,000 Imperial credits (new)
65,000 (used)
Technical specifications
Length
12.5 meters (41 ft)
Width
11 meters (36 feet 1 in)
Height/depth
4.4 meters (14 ft 5 in)
Mass
10 metric tons
...
Class 1
Hyperdrive system
Koensayr GBk-585 hyperdrive motivators (4)
Power plant
Novaldex 04-Z cryogenic power generator
Shielding
Chempat "Defender" deflector shield projector
...
Fabritech ANs-5d "lock track" full-spectrum transceiver with PA-9r long-range phased tachyon detection array and PG-7u short-range primary threat analysis grid
Targeting systems
Fabritech ANq 3.6 tracking computer with IN-344-B "Sightline" holographic imaging system
Navigation system
Astromech droid (up to 10 sets of hyperspace coordinates)
Countermeasures
...
The T-65B X-wing starfighter, referred to as the T-65B space superiority fighter, or T-65B X-wing multi-role starfighter, was manufactured by Incom Corporation. It was designed to excel in all aspects of starfighter combat, being highly maneuverable and heavily shielded, with a small profile that made it harder to hit. Unlike other starfighters the X-wing could excel in atmospheric flight. This included outmaneuvering the TIE fighter, which was otherwise faster and more maneuverable than the X-wing in space. The X-wing was classified as a starfighter, specifically a snub-fighter due to its size. The starship weighed 18,000 kg.
...
―Mon Mothma, "Short Notes on the History of the Rebel Alliance Navy"
...
Several T-65Bs were kept at the Alliance's hidden fortress on Yavin 4. X-wings were used alongside Y-wings in the Battle of Scarif, aiding the rebel fleet above the planet to help Rogue One steal the Death Star plans. During the Battle of Yavin, Luke Skywalker was assigned to an X-wing for the battle, the goal of which was to destroy the Empire's approaching Death Star. Although many of the X-wing pilots were killed, Skywalker was able to launch his proton torpedoes into the battlestation's exhaust port, causing a chain reaction and destroying it. Wedge Antilles was the only other X-wing pilot who survived.
...
―Resistance pilot Poe Dameron on the T-65's stats

In the years following the destruction of the Galactic Empire, newer X-wing models, such as the T-70 X-wing starfighter would eventually fall into the hands of the Resistance, and the T-85 X-wing would see use in the New Republic Defense Fleet. Despite the wide-spread retiring of T-65s in favor of newer models, Luke Skywalker, now a Jedi Master, continued to use Red Five as his main starship.

While training a new generation of Jedi, Skywalker lost his students when the dark side adept Snoke drew Skywalker's nephew, Ben Solo to the dark side of the Force. Becoming "Kylo Ren," Solo and the Knights of Ren killed all of Skywalker's students and burned his Jedi temple. In search of the First Jedi Temple, Skywalker went into exile and traveled aboard his X-wing alone. After traveling to Ahch-To, he purposely ditched his X-wing in a shallow inlet, leaving himself stranded on the island, and cut himself from the Force, until Rey came to be his final apprentice before dying and becoming one with the Force.

Rey later purposely crash-landed Kylo Ren's TIE whisper on Ahch-To, wanting to do the same thing Luke did, but his spirit lifted his old X-wing out of the water for her to travel to Exegol and then return to the Resistance base on Ajan Kloss after the war ended.
...
For the Star Wars Anthology Series film, Rogue One: A Star Wars Story, the X-wings at the Rebel base were realized by a combination of full-size props and cutouts, similar to the fighters in the original Star Wars film.
...
Star Wars: The Last Jedi: The Visual Dictionary stated that Luke Skywalker had salvaged an S-foil from the X-wing which he used as a door for his hut. This is apparently contradicted by Star Wars: Episode IX The Rise of Skywalker, which depicts his X-wing with its S-foils intact.
...
Star Wars: Build Your Own R2-D2 3 
...
Star Wars: X-Wing Miniatures Game — Saw's Renegades Expansion Pack 
Star Wars: X-Wing Second Edition Core Set 
Star Wars: Build Your Own X-Wing 1 
Star Wars: X-Wing Second Edition — T-65 X-Wing Expansion Pack 
